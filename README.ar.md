...
متصفح AltSource محلي أولاً مبني على C11.

الويب: https://xiaozhang-qd.github.io/AltSource-Center/web/

الإصدارات: https://github.com/XiaoZhang-qd/AltSource-Center/releases

إدارة المصادر والبحث عن التطبيقات وعناوين IPA وبروتوكولات التثبيت والسمات وتعدد اللغات.
